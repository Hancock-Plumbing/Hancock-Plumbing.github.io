...
const OUT_DIR = path.join(ROOT, '_screenshots/mobile');
...
async function main() {
  ...
  for (const [urlPath, name] of PAGES) {
    ...
    console.log(`Mobile: ${urlPath}`);
    await page.goto(`http://localhost:8768${urlPath}`, { waitUntil: 'networkidle0', timeout: 30000 });
